...
class Generator
{
    ...
    /**
     * Generate class files in the unified namespaces for the currently installed edition of O3-Shop
     */
    ...
    {
        $expectedShopEditions = [static::COMMUNITY_EDITION];
